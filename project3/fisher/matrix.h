// header file for matrix2 template class
...
#ifndef __mjdmatrix2_h
#define __mjdmatrix2_h
#include <iostream>
#include <cstdlib>
using namespace std;
// generic object (class) definition of matrix2:
template <class D> class matrix2{
  // NOTE: maxsize determines available memory storage, but
  // actualsize determines the actual size of the stored matrix2 in use
  // at a particular time.
  int maxsize;  // max number of rows (same as max number of columns)
  int actualsize;  // actual size (rows, or columns) of the stored matrix2
  D* data;      // where the data contents of the matrix2 are stored
  void allocate()   {
    delete[] data;
